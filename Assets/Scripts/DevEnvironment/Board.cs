...
public class Board : MonoBehaviour {
	...
	public bool yieldViewForCompile = false;
	private int yieldFrameCounter;
    public float frameUpAmount = 0.000000523f;

	void Update()
	{
		//if (!yieldViewForCompile)
		//	return;
	...
	public void SetShouldYieldView(bool flag)
	{
		yieldViewForCompile = flag;
	}
